...
if (array_key_exists('logout', $_POST)) {
    logout();
    // After logout (session_destroy etc) redirect to itself - to index.php
    // So we can avoid "Confirm Form Resubmission"
...
<form action="index.php" id="logout" method="post">
    <input class="btn btn-group-lg btn-danger" type="submit" name='logout' value="Log Out!">
</form>
</body>
<script>
